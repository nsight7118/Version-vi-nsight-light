    ...
    func addDiscussions()
    {
       ...
       discusions.append(Discussion1)
        ...
        let Discussion6 = Discussion(
            ...
            _content: "Mar 07, 2015 - If we can improve our brain functionality it is obvious that we’ll be able to perform better. We can learn faster, do more skills, retain more information, and so on.  is a blog Thank you brain is specifically designed and purposed to help individuals improve their cognitive abilities.",
            _email: "jayanthi@enlighten.com",
            _about: "this is it!",
            _audience: "Students",
            _classification: "Goals"
